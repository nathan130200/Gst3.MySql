...
namespace Gst3.MySql.Instructions
{
	public class JunctionExp : Exp
	{
		...
		public override string ToString(ISqlDialect dialect)
		{
			...
			return Not ? string.Format(format, (!exp1).ToString(dialect), and ? "or" : "and",
				(!exp2).ToString(dialect)) : string.Format(format, exp1.ToString(dialect), and ? "and" : "or", exp2.ToString(dialect));
		}
